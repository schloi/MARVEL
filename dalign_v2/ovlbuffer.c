...
char* pathLas( char* base, char* aroot, int ablockID, char* broot, int bblockID )
{
...
void Write_Overlap_Buffer( Align_Spec* spec, char* base, char* ablock, char* bblock, int lastRead )
{
    // sort all overlaps
