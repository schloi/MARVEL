...
//Align_Spec *New_Align_Spec(double ave_corr, int trace_space, float *freq);// HEIDELBERG_MODIFICATION
...
int Compute_Trace_PTS(Alignment *align, Work_Data *work, int trace_spacing, int mode, int debug );
